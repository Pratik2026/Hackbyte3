    ...
    return (
      ...
      <div className="relative md:my-32 lg:my-0 monitor:my-16">
        ...
        <Image
          ...
          alt="Hackbyte 3.0"
          className="w-[200px] xs:w-[250px] sm:w-[140px] md:w-[250px] lg:w-[350px] xl:w-[500px] absolute top-[105%] xs:top-[88%] sm:top-[57%] left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        />
